...
func isOrdered(object interface{}, allowedComparesResults []CompareType, // isOrdered checks that collection contains orderable elements.
	...
	failMessage string, msgAndArgs ...interface{}) bool {
